...
import 'package:house_party/pages/create_event/decoration_page.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: SvgPicture.asset("assets/icons/big_drinks.svg")),
            const SizedBox(height: 38,),
            const Text("Will there be alcohol?",
              style: TextStyle(
                color: Colors.white,
                fontSize: 14,
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Padding(
                  ...
                  child: Text("Yes, I need to order it",
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w700,
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Padding(
                  ...
                  child: Text("Bring your own bottle",
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w700,
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => const DecorationPage()));
