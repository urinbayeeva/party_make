...
import 'package:house_party/pages/create_event/board_games.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: SvgPicture.asset("assets/icons/ballons.svg")),
            const SizedBox(height: 38,),
            const Text("Do you wish to hire a decorator?",
              style: TextStyle(
                color: Colors.white,
                fontSize: 14,
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Padding(
                  ...
                  child: Text("I will decorate myself",
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w700,
